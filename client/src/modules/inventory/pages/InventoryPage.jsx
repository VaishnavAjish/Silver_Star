...
export default function InventoryPage() {
  ...
  const menuItems = row => {
    ...
    return [
      ...
      perms.canTransfer && { label: 'Stock Transfer', icon: <Send size={11} />, fn: () => openStockTransferModal([row], () => { load(); }), color: 'var(--brand-dark)' },
                ...
                {(() => {
                  if (selectedTransferRows.length === 1) {
                    ...
                    return [
                      ...
                      perms.canTransfer && { label: 'Stock Transfer', icon: <Send size={12} />, fn: () => openStockTransferModal([lot], () => { load(); }), accent: true },
